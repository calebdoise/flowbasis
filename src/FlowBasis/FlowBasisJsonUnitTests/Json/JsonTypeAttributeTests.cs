...
{
    [TestClass]
    public class JsonTypeAttributeTests
    {
        [TestMethod]
        public void Test_MapperType()
        {
            var jsonSerializer = new JsonSerializationService(() => new JObjectRootMapper());
        ...
        [JsonType(MapperType = typeof(TestObjectMapper))]
